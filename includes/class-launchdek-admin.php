	...
	public function enqueue_scripts( $hook ) {
		...
		$localize = array(
				...
				'strings'   => array(
					...
					'siteInfoConnection'     => __( 'Connection', LAUNCHDEK_TEXT_DOMAIN ),
					'siteInfoLastError'      => __( 'Last error', LAUNCHDEK_TEXT_DOMAIN ),
					'siteInfoClientPanel'    => __( 'Client panel', LAUNCHDEK_TEXT_DOMAIN ),
					'siteInfoAppPassword'    => __( 'App password', LAUNCHDEK_TEXT_DOMAIN ),
					'siteInfoIntegration'    => __( 'Integration', LAUNCHDEK_TEXT_DOMAIN ),
					'siteInfoTags'           => __( 'Tags', LAUNCHDEK_TEXT_DOMAIN ),
					'siteInfoUpdated'        => __( 'Updated', LAUNCHDEK_TEXT_DOMAIN ),
					'siteInfoYes'            => __( 'Yes', LAUNCHDEK_TEXT_DOMAIN ),
					'siteInfoNo'             => __( 'No', LAUNCHDEK_TEXT_DOMAIN ),
					'siteInfoConfigured'     => __( 'Configured', LAUNCHDEK_TEXT_DOMAIN ),
					'siteInfoMissing'        => __( 'Missing', LAUNCHDEK_TEXT_DOMAIN ),
					'siteGroupAdd'           => __( 'Add group…', LAUNCHDEK_TEXT_DOMAIN ),
					'siteGroupAddLabel'      => __( 'New group name', LAUNCHDEK_TEXT_DOMAIN ),
					'siteGroupAddSave'       => __( 'Add group', LAUNCHDEK_TEXT_DOMAIN ),
					'siteGroupAddCancel'     => __( 'Back', LAUNCHDEK_TEXT_DOMAIN ),
					'siteGroupNameRequired'  => __( 'Enter a group name.', LAUNCHDEK_TEXT_DOMAIN ),
					'siteGroupAdded'         => __( 'Group added.', LAUNCHDEK_TEXT_DOMAIN ),
					'siteAddToGroup'         => __( 'Add to group', LAUNCHDEK_TEXT_DOMAIN ),
					'siteAddToGroupTagRequired' => __( 'Enter a tag name.', LAUNCHDEK_TEXT_DOMAIN ),
